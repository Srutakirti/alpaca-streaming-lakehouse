# WebSocket extractor (Rust): Alpaca → Kafka

This component was imported from `feat/tansu-iceberg-pipeline` at `e55c880` for
the clean-slate pipeline. It is maintained here and remains a producer only:
it forwards Alpaca WebSocket frames unchanged to Tansu/Kafka.
